...
export function SparklesPreview() {
  return (
    <div className="h-[32rem] w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
      <h1 className="md:text-7xl sm:text-5xl text-3xl lg:text-9xl font-bold text-center text-white relative z-20 rubik-iso-regular">
        Technomantra
      </h1>
